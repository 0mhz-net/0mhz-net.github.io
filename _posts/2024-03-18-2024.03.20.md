...
The collection was renamed to the “0MHz DOS Collection”, and we put up a [GitHub repository](https://github.com/0mhz-net/0mhz-collection), as well as a web site at [0mhz.net](https://0mhz.net). We then went on to add a ton more game configurations, and made it into a project with a simple build script for anyone wanting to help out.
...
Oh, and if someone wants to take a crack at designing a logo/wordmark for “0MHz DOS Collection” (maybe something based on the MHz LCD segment displays on old PCs?), we'd love to see it! Monochrome vector (SVG), please, so it can be used in e.g. the navigation header on [0mhz.net](https://0mhz.net).
